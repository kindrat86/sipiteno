...
import { ArrowLeft, CheckCircle, Building2, Globe, MapPin, DollarSign, TrendingUp, Lightbulb } from "lucide-react";
...
import { getServiceInfo, ALL_SERVICE_SLUGS } from "@/data/countryServices";
...
// Registry of icon components for dynamic rendering
import {
  Target, Handshake, Globe as GlobeIcon, TrendingUp as TrendingIcon,
  Brain, Zap, BarChart3, Users, Search, FileText, Share2, Mail,
  RefreshCw, Settings, Cloud, Shield, ClipboardList, AlertTriangle,
  Layout, MousePointerClick, DollarSign as DollarIcon
} from "lucide-react";

const iconMap: Record<string, React.ElementType> = {
  Target, Handshake, Globe: GlobeIcon, TrendingUp: TrendingIcon,
  Brain, Zap, BarChart3, Users, Search, FileText, Share2, Mail,
  RefreshCw, Settings, Cloud, Shield, ClipboardList, AlertTriangle,
  Layout, MousePointerClick, DollarSign: DollarIcon,
};

const CountryServicePage = () => {
  const { country: countrySlug, service: serviceSlug } = useParams<{ country: string; service: string }>();
  
  const country = getCountryBySlug(countrySlug || "");
  const service = getServiceInfo(serviceSlug || "");
  const serviceLabel = serviceSlug ? (serviceLabels[serviceSlug] || serviceSlug.replace(/-/g, " ").replace(/\b\w/g, l => l.toUpperCase())) : "";
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16 container mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground mb-6">This location or service combination doesn't exist.</p>
  ...
  const description = `Sipiteno provides ${service.serviceName.toLowerCase()} in ${country.name} through remote delivery for clients across ${country.region}.`;
  ...
  const otherServices = ALL_SERVICE_SLUGS.filter(s => s !== service.serviceSlug).slice(0, 3);
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-24 pb-16">
          ...
          <section className="container mx-auto px-6 mb-16">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                Sipiteno delivers {service.serviceName.toLowerCase()} in {country.name} with on-the-ground presence and deep local market intelligence. {country.opportunity}
              </p>

              <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 mb-8">
                <h2 className="font-semibold text-foreground mb-4">At a Glance</h2>
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li><Globe className="w-4 h-4 inline text-primary mr-2" /><strong>Region:</strong> {country.region}</li>
                  <li><DollarSign className="w-4 h-4 inline text-primary mr-2" /><strong>Economy:</strong> {country.economicContext}</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          {/* Service Highlights */}
          <section className="container mx-auto px-6 mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-8">{serviceLabel} Services</h2>
          ...
          {/* Business Culture */}
          <section className="container mx-auto px-6 mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-8">Business in {country.name}</h2>
            <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="mt-6 bg-card/50 border-2 border-border rounded-xl p-6">
              <h3 className="font-semibold mb-4">Our Engagement Approach</h3>
          ...
          <section className="container mx-auto px-6">
            <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl p-8 md:p-12 text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Schedule a consultation to discuss your {serviceLabel.toLowerCase()} needs in {country.name}.
              </p>
